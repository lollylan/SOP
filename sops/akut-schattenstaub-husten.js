PCM.registerSOP({
  id: 'schattenstaub-husten',
  titel: 'Schattenstaub-Husten',
  untertitel: 'Akut - Staub aus alten Gewoelben',
  icon: 'SCH',
  farbe: '#4A235A',
  version: '1.0-fantasy',
  stand: '13.06.2026',
  ...
  schritte: [
    { nr: 1, titel: 'Stoppzeichen pruefen', rolle: 'Heilhaus-Team', rolleStil: 'red', farbe: '#C0392B', offen: true, elemente: [
      { typ: 'checkliste', id: 'redflags', stil: 'rot', items: [
        ...
        'schwarzer Staub auf echter Kleidung statt Demo-Requisite',
        'Fallkarte verwechselt Gewoelbe und Waldlager'
      ] },
      { typ: 'split', zellen: [
        { stil: 'rot', titel: 'Stoppzeichen', text: 'Demo-Fall pausieren und Freigabe einholen.' },
        { stil: 'gruen', titel: 'Kein Stoppzeichen', text: 'Fiktive Akutstruktur fortsetzen.' }
      ] }
    ] },
    { nr: 2, titel: 'Fallmarker erfassen', rolle: 'Schreiber/in', farbe: '#2471A3', offen: true, elemente: [
      ...
      { typ: 'checkliste', id: 'signale', stil: 'gruen', items: [
        'rau klingende Erzaehlung',
        'grauer Staubrand an der Demo-Maske',
        'Hustenreim wird im Protokoll erwaehnt',
        'Laterne flackert beim Vorlesen'
      ] }
    ] },
    { nr: 3, titel: 'Beobachtung und Demo-Vorgehen', rolle: 'Heilhaus-Team', rolleStil: 'green', farbe: '#1E8449', elemente: [
      { typ: 'checkliste', id: 'massnahmen', stil: 'gruen', items: [
        'Demo-Maske als Requisite markiert',
        'Staubquelle auf Fallkarte notiert',
        'Fenster im Uebungsraum symbolisch geoeffnet',
        'Rueckfrage an Aeltestenrat vorbereitet',
        'Demo-Charakter erklaert',
        'Hinweis: reale Inhalte muessen durch eigene SOPs ersetzt werden'
      ] },
      { typ: 'icd', id: 'diagnosen', items: [
        { code: 'FH-A01', text: 'Schattenstaub-Husten Basisfall' },
        { code: 'FH-A01B', text: 'Schattenstaub-Husten mit Ratsfreigabe' }
      ] }
    ] }
  ],
  auswertung: function (s) {
    ...
    return { redflag: stopp, bannerText: 'Schattenstaub-Husten: Stoppzeichen markiert - Demo-Fall pausieren.', meldungen: meldungen };
  },
  baustein: function (s) {
    var d = s.dauer || {};
    var an = 'Fantasy-Demo-Akutkontakt wegen Schattenstaub-Husten. ';
    ...
    var th = 'Demo-Vorgehen zu Schattenstaub-Husten. ';
