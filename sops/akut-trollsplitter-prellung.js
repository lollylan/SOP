PCM.registerSOP({
  id: 'trollsplitter-prellung',
  titel: 'Trollsplitter-Prellung',
  untertitel: 'Akut - stumpfer Treffer im Trainingshof',
  icon: 'TRL',
  farbe: '#5D6D7E',
  version: '1.0-fantasy',
  stand: '13.06.2026',
  ...
  schritte: [
    { nr: 1, titel: 'Stoppzeichen pruefen', rolle: 'Heilhaus-Team', rolleStil: 'red', farbe: '#C0392B', offen: true, elemente: [
      { typ: 'checkliste', id: 'redflags', stil: 'rot', items: ['Der Fall ist nicht eindeutig als Fantasy-Demo gekennzeichnet', 'Echte personenbezogene Daten wurden eingetragen', 'Die Uebungsperson bittet um eine reale Entscheidung', 'echte Verletzung statt Spielmarke', 'Trainingswaffe nicht als Requisite gekennzeichnet'] }
    ] },
    { nr: 2, titel: 'Fallmarker erfassen', rolle: 'Schreiber/in', farbe: '#2471A3', offen: true, elemente: [
      ...
      { typ: 'checkliste', id: 'signale', stil: 'gruen', items: ['blauer Spielstein auf dem Trefferfeld', 'Trollsplitter-Marke liegt neben der Figur', 'Bewegung im Brettspiel eingeschraenkt', 'Begleitmarker Steinlaerm vorhanden'] }
    ] },
    { nr: 3, titel: 'Beobachtung und Demo-Vorgehen', rolle: 'Heilhaus-Team', rolleStil: 'green', farbe: '#1E8449', elemente: [
      { typ: 'checkliste', id: 'massnahmen', stil: 'gruen', items: ['Requisitenstatus geprueft', 'Trefferfeld im Plan markiert', 'Schonrunde im Spiel vereinbart', 'Rueckfrage bei der Spielleitung notiert', 'Demo-Charakter erklaert', 'Hinweis: reale Inhalte muessen durch eigene SOPs ersetzt werden'] },
      { typ: 'icd', id: 'diagnosen', items: [{ code: 'FH-A03', text: 'Trollsplitter-Prellung Basisfall' }, { code: 'FH-A03B', text: 'Trollsplitter-Prellung mit Ratsfreigabe' }] }
    ] }
  ],
  auswertung: function (s) {
    ...
    return { redflag: stopp, bannerText: 'Trollsplitter-Prellung: Stoppzeichen markiert - Demo-Fall pausieren.', meldungen: meldungen };
  },
  baustein: function (s) {
    var d = s.dauer || {};
    var an = 'Fantasy-Demo-Akutkontakt wegen Trollsplitter-Prellung. ';
    ...
    var th = 'Demo-Vorgehen zu Trollsplitter-Prellung. ';
